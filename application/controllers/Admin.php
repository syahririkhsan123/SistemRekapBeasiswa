...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->load('index','contents','admin/admin_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'jabatan' => $row->jabatan,
            ...
            $this->template->set('tittle','Dashboard');
            $this->template->load('index','contents','admin/admin_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->template->set('tittle','Dashboard');
        $this->template->load('index','contents','admin/admin_form', $data);
    }
